...
! function(e) {
    ...
    e(function() {
        ...
        e(".post-type-archive-project").find(".numeric-navigation").on("click", ".page-numbers.next", function(t) {
            ...
            }), s.find(".menu .menu-item-has-children").prepend('<span class="toggle-children "><i class="lnr lnr-chevron-right" aria-hidden="true"></i></span>'), s.find(".menu .menu-item-has-children").each(function() {
                var a = "";
                e(this).children("a").hasClass("dropdown-toggle") && (a = e(this).children(".dropdown-toggle").html()), e(this).children("ul").prepend('<li class="menu-parent-items">' + a + "</li>"), e(this).children("ul").prepend('<li class="menu-back">Back to Menu</li>')
            ...
            function() {
                ...
                t.addClass("active"), s.filter(":first").addClass("active"), i.on("click", function(a) {
                    var t = e(this);
